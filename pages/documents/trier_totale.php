...
<?php
      ...
      $stmt = $conn->prepare("SELECT * from documents order by nombre_page");
      $stmt->execute();
      $rows = $stmt->fetchAll();
      ...
      if(isset($_GET["filtrer_par_date"])){
           $stmt = $conn->prepare("SELECT * from documents ORDER BY num_doc desc");
           $stmt->execute();
   ...
   ?>
       ...
       <div class="mb-3 d-flex gap-2">
           ...
           <div id="trier-detaills" >
               ...
               <a class="btn btn-secondary btn-sm" href="trier_date.php">par date</a>
           </div>
       </div>
       ...
       <div class="d-flex justify-content-between">
               <h2>Trie par totale de pages</h2>
